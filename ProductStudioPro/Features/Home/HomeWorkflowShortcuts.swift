...
/// Compact workflow launcher — avoids duplicating the primary capture action.
struct HomeWorkflowShortcuts: View {
    let onBatchCapture: () -> Void
    let onMultiAngleCapture: () -> Void
            ...
            VStack(spacing: PSDesignSpacing.sm) {
                SelectionCard(action: {
                    ...
                    workflowRow(
                        ...
                        title: "Batch Capture",
                        detail: "Photograph multiple products"
                    )
                }
                ...
                SelectionCard(action: {
                    ...
                    workflowRow(
                        ...
                        title: "Multi-Angle Product",
                        detail: "Capture every angle for one product"
                    )
                }
            }
        }
